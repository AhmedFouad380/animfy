    ...
    <div class="left-content">
      ...
      <div class="card">
        ...
        <div class="thumbnail-wrapper">
          <img src="{{ asset('storage/' . $object->thumbnail) }}" onerror="this.src='{{ asset('imgs/courses-thumbnails/blender-thumbnail.jpg') }}'" alt="Object Thumbnail" class="course-thumbnail">
        </div>

        <!-- TITLE -->
        <h1 class="course-title">{{ $object->title }}</h1>

        <h2>{{ app()->getLocale() === 'ar' ? 'حول هذا المجسم (About this 3D Object)' : 'About this 3D Object' }}</h2>
      ...
      <div class="sticky-wrapper">
        <div class="price-card">
          ...
          @if($isPurchased)
            ...
            <a href="{{ route('download.object', $object->id) }}" class="buy-btn" style="text-align: center; display: block; text-decoration: none; line-height: 1.1; margin-top: 10px; background: #10b981;">
                <i class="fa-solid fa-download" style="margin-right: 8px;"></i>
                {{ app()->getLocale() === 'ar' ? 'تحميل الملف الآن' : 'Download Now' }}
            </a>
          @else
            @auth
              <a href="{{ route('checkout.object', $object->id) }}" class="buy-btn" style="text-align: center; display: block; text-decoration: none; line-height: 1.1; margin-top: 10px;">
